...
import CapabilityDelegator from "CapabilityDelegator"
import CapabilityFilter from "CapabilityFilter"
import HybridCustody from "HybridCustody"

import FlowSign from "FlowSign"

// Found this Transaction that Publishes a Child Account and also Claims it on the Parent from the walletless-arcade-example
// https://github.com/onflow/walletless-arcade-example/blob/main/apps/rps-game/cadence/transactions/hybrid-custody/add-as-child-multisign.ts#L1
...
transaction(childAccountFactoryAddress: Address, childAccountFilterAddress: Address) {
    ...
    prepare(parent: AuthAccount, child: AuthAccount) {
        ...
        // --------------------- Begin FlowSign setup of parent account ---------------------
        //
        ...
        // --------------------- End FlowSign setup of parent account ---------------------
